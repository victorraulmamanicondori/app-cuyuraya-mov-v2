...
public class Constantes {
    ...
    // public static final String BASE_URL = "http://104.251.212.105:9000/api/"; // PARA SERVIDOR EN LA NUBE
    // public static final String BASE_URL = "http://10.0.2.2:9000/api/"; // PARA EMULADOR DE ANDROID STUDIO
    public static final String BASE_URL = "http://app-servicio-backend.local:9000/api/"; // PARA EMULADOR MEMU PLAY
